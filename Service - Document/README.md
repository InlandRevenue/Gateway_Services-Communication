...
- YAML file
	- View and download [Document service YAML file](Document%202022-04-11.yaml)
...
>**NOTE:** The included [Document%202022-04-11.yaml](Document.yaml) file can be used along with an OpenAPI editor such as [editor.swagger.io](https://editor.swagger.io) to view technical specifications for this operation and generate example client code. 
